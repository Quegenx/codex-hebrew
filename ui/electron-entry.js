...
window.installChatGPTHebrew = function(options) {
  ...
  const rtl = installRTL({css:options.css,locale:options.locale || 'he',translations:options.translations,directionalIcons:options.directionalIcons||options.direction?.directionalIcons});
  function apply() {
