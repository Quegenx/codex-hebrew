...
const known=a.hash==='64fc2f27d2dddfa968acfacbe5e4e0328071bdc406351ff4a7d18f0b4692c83d'&&source.includes('Tle as Pln')&&source.includes('c as tdn')&&source.includes('return e||t||`ltr`');
const direction=known?{moduleUrl:`app://-/${moduleFile.slice('webview/'.length)}`,reactExport:'tdn',directionExport:'Pln',directionalIcons}:null;
