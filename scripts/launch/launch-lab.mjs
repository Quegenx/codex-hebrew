...
import {buildWindowsWrapper} from '../build/build-windows-wrapper.mjs';
...
const launchedExecutable=process.platform==='darwin'?buildMacOSWrapper({executable:target.executable,runtime}).applicationExecutable:process.platform==='win32'?buildWindowsWrapper({executable:target.executable,runtime}).executable:target.executable;
