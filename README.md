...
1. פתחו את [עמוד ההורדות](https://github.com/Quegenx/codex-hebrew/releases).
2. ב־Mac עם Apple Silicon ו־macOS 13 ומעלה הורידו את `Codex-Hebrew-macOS-arm64.dmg`.
3. פתחו את הקובץ, הפעילו את **Install Codex Hebrew** ולחצו **Install**.
